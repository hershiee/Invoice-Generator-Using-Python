...
def header(header,pdf):
  ...
  pdf.drawString(30,800,"GUPTA KIRANA STORE")
  pdf.setFont("Courier-Bold",11)
  pdf.drawString(30,785,"INFRONT OF ARMY CANTEEN,")
  pdf.drawString(30,770,"KHATIMA SITARGANJ ROAD,")
  pdf.drawString(30,755,"262308. Phone: 9045217201")
...
def About():
  ...
  pdf.setFont("Courier-Bold",20)
  pdf.drawString(40,700,"Harshita Gupta")
  pdf.setFont("Courier-Bold",15)
  pdf.drawString(40,650,"Student, ")
  pdf.drawString(40,630,"Computer Science & Engineering,")
  pdf.drawString(40,610,"JB Institute of Technology,")
  pdf.drawString(40,590,"Dehradun, 248197.")
  pdf.drawString(40,550,"Contact: gharshita035@gmail.com")
  pdf.save()
